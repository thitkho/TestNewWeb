...
TRUNCATE TABLE tadmzipcd;
                                CREATE TEMP TABLE tmp_table_idv(
		                                local_code character varying,
		                                house_name_kana character varying,
		                                house_name_kanj character varying,
                                ...
                                CREATE TEMP TABLE tmp_table(
                                    ...
                                    old_zipcode character varying, 
                                    zipcode character varying, 
                                    state_kana character varying,
                                    city_kana character varying, 
                                    town_kana character varying, 
	                                state character varying, 
	                                city character varying,
	                                town character varying,
	                                a character varying,
                                ...
                                COPY tmp_table FROM 'C:\inetpub\wwwroot\Outputs\KEN_ALL.csv' WITH CSV DELIMITER ',' encoding 'sjis' FORCE NOT NULL old_zipcode, zipcode, state_kana, city_kana, town_kana, state, city, town  ;
		                        COPY tmp_table_idv FROM 'C:\inetpub\wwwroot\Outputs\JIGYOSYO.csv' WITH CSV DELIMITER ',' encoding 'sjis' FORCE NOT NULL  house_name_kana, house_name_kanj, state, city, town, house, zipcode, old_zipcode  ;
		                        COPY tmp_table_idv FROM 'C:\inetpub\wwwroot\PostalCode\add_idv_postalcode.csv' WITH CSV DELIMITER ',' encoding 'sjis' FORCE NOT NULL  house_name_kana, house_name_kanj, state, city, town, house, zipcode, old_zipcode  ;

                                INSERT INTO tadmzipcd
                                SELECT DISTINCT ON(local_code, zipcode) local_code, zipcode, state, city, town, '20220627140023','admin'
                                FROM (
			                        select distinct local_code, zipcode, state, city, town from tmp_table
			                        union
			                        select distinct local_code, zipcode, state, city, town FROM tmp_table_idv
		                        ) as tmp;
                                DROP TABLE tmp_table;
                                DROP TABLE tmp_table_idv;